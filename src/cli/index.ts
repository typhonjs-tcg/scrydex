...
.option('--decks', 'Provide a file or directory path of CSV card collections representing active decks.')
.option('--external', 'Provide a file or directory path of CSV card collections representing externally organized collections.')
